...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, WorkoutFragment.OnFragmentInteractionListener {
    private NavigationView navigationView;
    private WorkoutFragment mWorkoutFragment = new WorkoutFragment();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camara) {
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.content, mWorkoutFragment)
                    .commit();
